...
public class UsuariosDataSource {
	...
	private String[] colunasUsuarios = { MySQLiteHelper.COLUNA_ID_USUARIO,
			MySQLiteHelper.COLUNA_USUARIO, MySQLiteHelper.COLUNA_SENHA,
			MySQLiteHelper.COLUNA_EMAIL };
	...
	public Usuarios insertUsuario(String usuario, String senha, String email) {
		...
		Cursor cursor = database.query(MySQLiteHelper.TABLE_USUARIOS,
				colunasUsuarios, MySQLiteHelper.COLUNA_ID_USUARIO + " = "
	...
	public void deleteUsuario(Usuarios usuario) {
		...
		database.delete(MySQLiteHelper.TABLE_USUARIOS,
				MySQLiteHelper.COLUNA_ID_USUARIO + " = " + id, null);
	}
