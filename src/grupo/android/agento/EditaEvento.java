...
public class EditaEvento extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		long id = intent.getLongExtra(AgentoEvento.ID_EVENTO, -1);
		...
		text.setText(eventoEditado.getEvento());
	...
	/**
	 * Salva as alterações feitas no evento
	 */
	...
	/**
	 * retorna para a activity anterior sem salvar nada
	 */
